...
export const TOPIC_GENERATOR_SYSTEM_PROMPT = ` '''
...
export const AUTOBLOG_REVIEW_PROMPT = ` """
...
// TODO: Does this need to be a passable variable?
export const SOCIAL_MEDIA_SYSTEM_PROMPT_AGENT = ` """
...
export const DRAFT_AGENT_SYSTEM_PROMPT = ` """
