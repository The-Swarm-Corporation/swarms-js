...
import { DYNAMIC_STOP_PROMPT, DYNAMICAL_TOOL_USAGE } from './swarms/prompts/tools.js';
...
export function autonomous_agent_prompt_v2( tools_prompt = DYNAMICAL_TOOL_USAGE, dynamic_stop_prompt= DYNAMIC_STOP_PROMPT, agent_name = null,) {
    return ` """
...
export function agent_system_prompt_2_v2(name) {
    return ` """
...
export function autonomous_agent_prompt( tools_prompt = DYNAMICAL_TOOL_USAGE, dynamic_stop_prompt = DYNAMIC_STOP_PROMPT, agent_name = null) {
...
export function agent_system_prompt_2( name ) {
...
export const AGENT_SYSTEM_PROMPT_3  = ` """
