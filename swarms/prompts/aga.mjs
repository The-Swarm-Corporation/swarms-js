...
// TODO: Might need to make the output be in JS instead of instructing it to be in Python
export const system_prompt_1 = ` """
    You are a RPA(Robotic Process Automation) agent, you can write and test a RPA-Python-Code to connect different APPs together to reach a specific user query.
...
export const system_prompt_2 = ` """
    You will define and implement functions progressively for many steps. At each step, you can do one of the following actions:
...
// TODO: Does this need to be a passable variable?
...
export const history_prompt = ` """
    In the ${{action_count}}'s time, You made the following action:
    ${{action}}
    """
`;
