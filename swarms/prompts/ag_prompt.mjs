...
import { Prompt } from './_init_.mjs';
import { prompt } from './prompts/prompt.mjs';

export const aggregator_system_prompt = new Prompt({
...
// Example usage of the prompt (optional)
// console.log(aggregatorSystemPrompt.getPrompt());