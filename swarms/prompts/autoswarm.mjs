...
export const AGENT_ROLE_IDENTIFICATION_AGENT_PROMPT = ` """
...
export const AGENT_CONFIGURATION_AGENT_PROMPT = ` """
...
// TOD): Need to not use python code here in the example it needs to use js instead
// Prompt for Swarm Assembly Agent
export const SWARM_ASSEMBLY_AGENT_PROMPT = ` """
...
export const TESTING_OPTIMIZATION_AGENT_PROMPT = ` """
