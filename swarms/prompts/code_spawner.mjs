...
export const IDEA_INTAKE_PROMPT = ` """
...
export const CODEBASE_PLANNING_PROMPT = ` """
...
export const FILE_WRITING_PROMPT = ` """
...
export const CODE_REFACTORING_PROMPT = ` """
...
export const GITHUB_PUSH_PROMPT = ` """
